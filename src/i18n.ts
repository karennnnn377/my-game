...
const L: Record<string, Entry> = {
  ...
  era_medieval: ["Medieval", "قرون وسطی", "العصور الوسطى"],
  era_early: ["Early Modern", "اوایل دوران مدرن", "الحديث المبكر"],
  era_modern: ["Modern", "مدرن", "الحديث"],
  era_now: ["Contemporary", "معاصر", "المعاصر"],
  // nav
  nav_search: ["Search", "جستجو", "بحث"],
  nav_settings: ["Settings", "تنظیمات", "الإعدادات"],
  nav_mybday: ["My Birthday", "تولد من", "عيد ميلادي"],
  // search
  search_title: ["Search The Legends", "جستجوی مشاهیر", "ابحث في المشاهير"],
  search_sub: ["Find any famous person across every category, country and era", "هر فرد مشهور را در همه دسته‌ها، کشورها و دوران‌ها پیدا کن", "اعثر على أي مشهور في كل فئة ودولة وعصر"],
  search_ph: ["Search name, country, category…", "نام، کشور، دسته را جستجو کن…", "ابحث عن اسم أو دولة أو فئة…"],
  found: ["legends found", "چهره یافت شد", "أسطورة وُجدت"],
  no_results: ["No legends match your search", "هیچ چهره‌ای با جستجوی تو پیدا نشد", "لا توجد نتائج مطابقة"],
  reset_filters: ["Reset Filters", "حذف فیلترها", "إعادة تعيين الفلاتر"],
  load_more: ["Load More", "بارگذاری بیشتر", "تحميل المزيد"],
  all_cats: ["All Categories", "همه دسته‌ها", "كل الفئات"],
  all_eras: ["All Eras", "همه دوران‌ها", "كل العصور"],
  fav_only: ["Favorites", "علاقه‌مندی‌ها", "المفضلة"],
  // person card / detail
  born_in: ["Born", "متولد", "وُلد في"],
  nationality: ["Nationality", "ملیت", "الجنسية"],
  profession: ["Profession", "حرفه", "المهنة"],
  era: ["Era", "دوران", "العصر"],
  difficulty: ["Difficulty", "سختی", "الصعوبة"],
  popularity: ["Fame Rating", "میزان شهرت", "مستوى الشهرة"],
  add_fav: ["Save", "ذخیره", "حفظ"],
  remove_fav: ["Saved", "ذخیره شد", "محفوظ"],
  play_cat: ["Play This Arena", "بازی در این زمین", "العب في هذه الساحة"],
  facts_title: ["Fast Facts", "حقایق جالب", "حقائق سريعة"],
  twins_title: ["Birthday Twins", "هم‌تولدی‌ها", "توائم الميلاد"],
  person_id: ["ID", "شناسه", "المعرّف"],
  // birthday screen
  bday_title: ["My Birthday", "تولد من", "عيد ميلادي"],
  bday_sub: ["Pick your birth date and meet the legends who share your day", "تاریخ تولدت را انتخاب کن و مشاهیر هم‌روزت را ببین", "اختر تاريخ ميلادك وقابل المشاهير الذين يشاركونك اليوم"],
  your_bday: ["Your Birthday", "تولد تو", "عيد ميلادك"],
  twins_found: ["legends share your day", "چهره هم‌روز تو هستند", "أسطورة تشاركك اليوم"],
  month_twins: ["Legends born in your month", "متولدین ماه تو", "مشاهير مواليد شهرك"],
  no_twins: ["No legend shares your exact day — here are the closest in your month", "هیچ چهره‌ای دقیقاً هم‌روز تو نیست — این‌ها نزدیک‌ترین‌های ماه تو هستند", "لا مشهور يشاركك يومك — هؤلاء الأقرب في شهرك"],
  // settings
  set_title: ["Settings", "تنظیمات", "الإعدادات"],
  set_lang: ["Language", "زبان", "اللغة"],
  set_sound: ["Sound Effects", "افکت‌های صوتی", "المؤثرات الصوتية"],
  set_cal: ["Default Calendar", "تقویم پیش‌فرض", "التقويم الافتراضي"],
  set_reset: ["Reset All Data", "حذف همه داده‌ها", "حذف كل البيانات"],
  set_reset_desc: ["Clears profile, XP, achievements and favorites", "پروفایل، تجربه، دستاوردها و علاقه‌مندی‌ها را پاک می‌کند", "يمسح الملف والخبرة والإنجازات والمفضلة"],
  set_confirm: ["Tap again to confirm", "برای تأیید دوباره بزن", "اضغط مجدداً للتأكيد"],
  set_reset_done: ["All data cleared", "همه داده‌ها پاک شد", "تم مسح كل البيانات"],
  set_about: ["About", "درباره", "حول"],
  set_about_d: ["A global famous-people quiz arena. Every portrait is original procedurally-generated artwork, every sound is synthesized in-browser — zero copyrighted media. Names and birth dates are facts of the public record.", "میدان جهانی کوییز مشاهیر. هر پرتره اثر هنری اوریجینال و رویه‌ساز است و هر صدا در مرورگر سنتز می‌شود — بدون رسانه کپی‌رایت‌دار. نام‌ها و تاریخ تولدها اطلاعات عمومی‌اند.", "ساحة اختبار مشاهير عالمية. كل لوحة عمل فني أصلي مُولّد برمجياً، وكل صوت مُصنّع داخل المتصفح — بلا وسائط منسوخة. الأسماء وتواريخ الميلاد حقائق عامة."],
  set_lang_d: ["Persian and Arabic switch the whole layout to right-to-left automatically.", "فارسی و عربی کل چیدمان را به‌صورت خودکار راست‌چین می‌کنند.", "الفارسية والعربية تحوّلان التخطيط كله إلى اليمين تلقائياً."],
  set_avatar: ["Your Avatar", "آواتار تو", "صورتك الرمزية"],
  set_danger: ["Danger Zone", "منطقه خطر", "منطقة الخطر"],
  set_confirm_q: ["Erase XP, levels, achievements, favorites and history forever?", "تجربه، سطح‌ها، دستاوردها، علاقه‌مندی‌ها و تاریخچه برای همیشه پاک شود؟", "حذف الخبرة والمستويات والإنجازات والمفضلة والسجل نهائياً؟"],
  set_yes: ["YES — ERASE", "بله — پاک کن", "نعم — امسح"],
  set_cancel: ["Cancel", "انصراف", "إلغاء"],
  on: ["ON", "روشن", "مفعل"],
  off: ["OFF", "خاموش", "معطل"],
  favorites: ["Favorites", "علاقه‌مندی‌ها", "المفضلة"],
  no_favs: ["No favorites yet — tap the ♥ on any legend card", "هنوز علاقه‌مندی نداری — روی ♥ هر کارت بزن", "لا مفضلة بعد — اضغط ♥ على أي بطاقة"],
  see_favs: ["Your Saved Legends", "چهره‌های ذخیره‌شده‌ات", "مشاهيرك المحفوظون"],
  // auto bio / facts
  bio_t: ["{name} is a {prof} from {country}. Born {month} {day}, {year} — {era} era.", "{name} یک {prof} اهل {country} است. متولد {day} {month} {year} — دوران {era}.", "{name} {prof} من {country}. وُلد في {day} {month} {year} — العصر {era}."],
  bio_t_noc: ["{name} is a {prof}. Born {month} {day}, {year} — {era} era.", "{name} یک {prof} است. متولد {day} {month} {year} — دوران {era}.", "{name} {prof}. وُلد في {day} {month} {year} — العصر {era}."],
  fact_born_year: ["Born in {year} — the {era} era.", "متولد سال {year} — دوران {era}.", "وُلد عام {year} — العصر {era}."],
  fact_twins: ["{n} other legends in the database share this exact birthday ({day} {month}).", "{n} چهره دیگر در پایگاه داده دقیقاً همین تاریخ تولد ({day} {month}) را دارند.", "{n} مشاهير آخرون في قاعدة البيانات يشاركون هذا الميلاد تماماً ({day} {month})."],
  fact_twins_none: ["One of the very few born on {day} {month} in the database.", "یکی از معدود متولدین {day} {month} در پایگاه داده.", "من القلائل المولودين في {day} {month} في قاعدة البيانات."],
  fact_country: ["One of {n} legends from {country} in the database.", "یکی از {n} چهره اهل {country} در پایگاه داده.", "واحد من {n} مشهوراً من {country} في قاعدة البيانات."],
  fact_fame: ["Fame rating {pop}/100 — {tier}.", "میزان شهرت {pop}/۱۰۰ — {tier}.", "مستوى الشهرة {pop}/100 — {tier}."],
  fame_top: ["a household name", "یک نام آشنا برای همه", "اسم يعرفه الجميع"],
  fame_high: ["widely recognized", "کاملاً شناخته‌شده", "معروف على نطاق واسع"],
  fame_mid: ["a rising legend", "افسانه‌ای در حال صعود", "أسطورة صاعدة"],
  fame_low: ["a deep-cut for true experts", "مخصوص خبره‌های واقعی", "للخبراء الحقيقيين فقط"],
};

/** singular profession per category [en, fa, ar] */
export const PROF: Record<string, [string, string, string]> = {
  football: ["Footballer", "فوتبالیست", "لاعب كرة قدم"],
  actors: ["Actor", "بازیگر مرد", "ممثل"],
  actresses: ["Actress", "بازیگر زن", "ممثلة"],
  singers: ["Singer", "خواننده", "مغنٍّ"],
  musicians: ["Musician", "نوازنده", "موسيقي"],
  composers: ["Composer", "آهنگساز", "ملحن"],
  rappers: ["Rapper", "رپر", "مغني راب"],
  basketball: ["Basketball Player", "بسکتبالیست", "لاعب سلة"],
  tennis: ["Tennis Player", "تنیسور", "لاعب تنس"],
  racing: ["Racing Driver", "راننده مسابقه‌ای", "سائق سباقات"],
  boxing: ["Boxer", "بوکسور", "ملاكم"],
  athletes: ["Athlete", "ورزشکار", "رياضي"],
  scientists: ["Scientist", "دانشمند", "عالِم"],
  astronauts: ["Astronaut", "فضانورد", "رائد فضاء"],
  historical: ["Historical Figure", "چهره تاریخی", "شخصية تاريخية"],
  leaders: ["World Leader", "رهبر جهان", "قائد عالمي"],
  artists: ["Artist", "هنرمند", "فنان"],
  writers: ["Writer", "نویسنده", "كاتب"],
  entrepreneurs: ["Entrepreneur", "کارآفرین", "رائد أعمال"],
  tech: ["Tech Figure", "چهره فناوری", "شخصية تقنية"],
  gaming: ["Gaming Personality", "چهره گیمینگ", "شخصية ألعاب"],
  tv: ["TV Personality", "چهره تلویزیونی", "شخصية تلفزيونية"],
  comedians: ["Comedian", "کمدین", "كوميدي"],
  directors: ["Film Director", "کارگردان", "مخرج"],
  internet: ["Internet Personality", "چهره اینترنت", "شخصية إنترنت"],
  iran: ["Iranian Icon", "چهره ایرانی", "أيقونة إيرانية"],
  world: ["World Icon", "چهره جهانی", "أيقونة عالمية"],
};
...
export const CAT_NAMES: Record<string, Entry> = {
  ...
  musicians: ["Musicians", "نوازندگان", "موسيقيون"],
  composers: ["Composers", "آهنگسازان", "ملحنون"],
  ...
  directors: ["Directors", "کارگردانان", "مخرجون"],
