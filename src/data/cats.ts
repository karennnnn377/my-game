...
export const CATS: CatMeta[] = [
  ...
  { id: "composers", icon: "🎼", c1: "#e8c07a", c2: "#7a5314" },
  ...
  { id: "directors", icon: "🎥", c1: "#f97316", c2: "#7c2d12" },
...
export const SIBLINGS: Record<CatId, CatId[]> = {
  ...
  musicians: ["musicians", "singers", "composers"],
  ...
  tv: ["tv", "comedians", "internet", "gaming", "directors"],
  comedians: ["comedians", "actors", "tv"],
  directors: ["directors", "actors", "actresses", "tv"],
